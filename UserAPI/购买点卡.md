...
```JSON
{
    "packList": [
        {
            "pointPackId": "3", //点卡ID
            "pointCardId": "wallex_CARD", //点卡标识
            "name": "早鸟", //点卡名称
            "pointCard": { //点卡本身数据
                "pointCardId": "wallex_CARD", //点卡ID
                "pointCardName": "Pts", //点卡名称
                "pointCardFullName": "wallex CARD", //点卡全名
    ...
    "balanceList": [
        {
            ...
            "pointCardMetadata": { // 注释跟下面那个一样哈
                "pointCardId": "wallex_CARD",
                "pointCardName": "Pts",
                "pointCardFullName": "wallex CARD",
...
[
    {
        "pointPackId": "2", //套餐ID
        "pointCardId": "wallex_UCARD",// 点卡ID 标识
        "name": "USDT点卡", // 套餐名称， 目前跟点卡名称一样,先用这个
        "pointCard": {
            "pointCardId": "wallex_UCARD", //点卡ID 标识
            "pointCardName": "USDT Points",// 点卡名称，先别用这个
            "pointCardFullName": "wallex UCARD", //点卡全名
