...
* 请求响应：
    ...
    ```JSON
    {
        ...
        "oAuthCodeResult": {
            ...
            "state":"SELECT",
            "redirectUrl":"http://www.wallex.us/s_api/basic/config"
        }
    }
    ```
...
* 说明：图片请求请使用www.wallex.cn/s_api访问
...
* 说明：此接口只能上传图片，如有其他需求，再议。图片请求请使用www.wallex.cn/s_api访问
...
* 请求响应：
    ...
    ```JSON
    {
        ...
        "authUrl":"otpauth://totp/wallex:186****0005?secret=DU7BB5HS6FPZRI66&issuer=wallex",
